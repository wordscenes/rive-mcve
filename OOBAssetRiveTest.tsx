...
export const OOBAssetRiveTest = () => {
  ...
  const assets = {
    ...
    'referenced_audio-2929340': {
      source: require('./assets/referenced_audio-3385087.wav'),
      // source: {
